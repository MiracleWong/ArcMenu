package com.miraclewong.arcmenu.view;
...
import com.miraclewong.arcmenu.R;

/**
 * Created by MiracleWong on 2015/6/9.
 */
public class ArcMenu extends ViewGroup implements OnClickListener {
    ...
    public ArcMenu(Context context, AttributeSet attrs, int defStyle) {
        ...
        mRadius = (int) a.getDimension(R.styleable.ArcMenu_radius, TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,
                100, getResources().getDisplayMetrics()));
    ...
    public void toggleMenu(int duration) {
        ...
        for (int i = 0; i < count - 1; i++) {
            ...
            tranAnim.setStartOffset((i * 100) / count);     // 平移的速度不一样
    ...
    private void rotateCButton(View v, float start, float end, int duration)
    {
        ...
        anim.setFillAfter(true);        // 旋转完成后停止
